...
public class CalculatorTest extends SeleniumTest {
	...
	public void mul1() {
		...
		wait.until(wd -> _page1.getDisplay().exists());
		logger.info("Page opened");
		_page1.multiply("23", "6");
		assertEquals("138".toString(), _page1.getDisplay().toString());
	...
	public void body() {
		...
		wait.until(wd -> new PageElement(_page, "input", "display").exists());
		new PageElement(_page, "input", "AC").click();
		new PageElement(_page, "input", "2").click();
		new PageElement(_page, "input", "3").click();
		new PageElement(_page, "input", "×").click();
		new PageElement(_page, "input", "6").click();
		new PageElement(_page, "input", "=").click();
		assertEquals("138".toString(), new PageElement(_page, "input", "display").toString());
	}
